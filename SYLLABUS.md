# CS 401 – Topics in Operating Systems - Syllabus
...
- **Semester/Block**: Fall 2025, Block 2 (10/21/2024 through 12/4/2024), **13** class sessions
- **Days and Time**: Tuesdays and Thursdays, 8:00 AM - 9:50 AM ([iCalendar File](https://github.com/fmillion-mnsu/cs401-f25/raw/master/cs401.ics))
- **Location:** WH 125 ([Building Map](https://mankato.mnsu.edu/globalassets/maps/university/buildings/wissink-hall-first-floor.pdf))
...
This course serves as an introduction to embedded computer systems and the unique aspects of programming in a constrained environment. Topics covered will include:

* Embedded systems - microcontrollers vs. "mini" PCs
* MicroPython programming on a microcontroller
* Some C and assembly language programming
* Using software to control physical devices (e.g. IoT)
* The unique constraints and limitations of embedded systems and how programs work within those constraints
* Operating systems for embedded microcontrollers (e.g. FreeRTOS)

This course will involve programming in Python as well as some minimal work in C and assembly language. 

You will be given a Raspberry Pi Pico for the course to use as your development environment for MicroPython. 

One assignment in this course involves small group work in groups of 3-4 students.

**There will also be a final exam** that will take place during finals week. The exam will be a coding exercise along with a few theory questions and will be taken on D2L during the class period on December 9th, 2025.

## Prerequisites

Admission to the upper division Computer Science program is required.

This course is aimed at students who know at least two programming languages at a functional level. We will use Python in the form of MicroPython for the bulk of the course. You will write some code for this course as part of your group projects and experiments. You are free to share the coding aspects of your course among your group members as your group feels appropriate, however you may not share code with other groups.
...
This course will involve one group project that you will work on in small groups of 3-4 students. The project will include planning for and developing an IoT device using the Raspberry Pi Pico and an accompany custom circuit that I will be providing about midway through the course.
...
Group Activities | 20%
Final Exam / Coding Exercise | 25%

There will be no quizzes for this course. The work you do in your individual assignments and group assignment will be ongoing throughout the block. Your final grade will be calculated based on the above categories.
